...
class FaqAnswerSheet {
  ...
  static Map<String, String> get _answers {
    ...
    return {
      // DT
      'DT는 어떻게 구매하나요?':
          '지갑(Wallet) > DT 충전에서 원하는 패키지를 선택해 결제할 수 있습니다.\n\n'
      ...
      'DT 유효기간이 있나요?':
          '네. DT는 결제(또는 지급) 후 최대 ${expiryYears}년까지 사용할 수 있으며, '
      ...
      '메시지 알림 설정은 어디서 하나요?':
          '앱 설정에서 알림을 켜고/끌 수 있습니다.\n\n'
          '기기 설정에서 UNO A 알림이 차단되어 있다면 기기 설정에서 알림 허용을 확인해 주세요.',

      // Account
      '비밀번호를 잊어버렸어요':
          '로그인 화면에서 비밀번호 재설정을 진행할 수 있습니다.\n\n'
          '재설정 메일이 오지 않는다면 스팸함을 확인해 주세요.',
      '계정을 삭제하고 싶어요':
          '계정 삭제는 보안 및 정산 이슈로 인해 고객센터 확인이 필요할 수 있습니다.\n\n'
