            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildArticle(isDark, '제1조 (수집하는 개인정보 항목)',
...
• 접속 IP, 접속 일시, 서비스 이용 기록'''),
                  _buildArticle(isDark, '제2조 (개인정보의 수집·이용 목적)',
...
• 서비스 개선: 이용 통계 분석, 서비스 개선 및 개발'''),
                  _buildArticle(isDark, '제3조 (개인정보의 보유 및 이용 기간)',
...
• 접속 로그: 3개월 (통신비밀보호법)'''),
                  _buildArticle(isDark, '제4조 (개인정보의 제3자 제공)',
...
권리 행사는 앱 내 설정 또는 고객센터를 통해 가능합니다.'''),
                  _buildArticle(isDark, '제7조 (개인정보 보호책임자)',
