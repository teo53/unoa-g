            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  // Section 1: DT 환불
                  _buildSectionTitle(isDark, '제1조 DT(디지털 이용권) 환불'),
                  const SizedBox(height: 12),
                  _buildArticle(isDark, [
                    '① DT는 UNO A 앱 내에서만 사용 가능한 서비스 전용 디지털 이용권입니다.',
                    ...
                    '⑥ DT의 유효기간은 구매일로부터 5년이며, 서비스 정책에 따릅니다.',
                  ...
                  _buildArticle(isDark, [
                    '① 환불 요청 방법:',
                    '   • DT 환불: 앱 > 지갑 > 거래내역에서 해당 구매건 선택 후 "환불 요청"',
                  ...
                  // Footer
                  Text(
                    '※ 본 환불 정책은 전자상거래 등에서의 소비자보호에 관한 법률, 콘텐츠산업진흥법 등 관련 법령에 따라 운영됩니다.',
                    style: TextStyle(
                      fontSize: 12,
                      color: isDark
