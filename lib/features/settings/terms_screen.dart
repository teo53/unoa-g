            ...
            child: SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildArticle(isDark, '제2조 (용어의 정의)', '''본 약관에서 사용하는 용어의 정의는 다음과 같습니다.

1. "서비스"란 회사가 제공하는 UNO A 플랫폼 및 관련 제반 서비스를 의미합니다.
2. "이용자"란 본 약관에 따라 서비스를 이용하는 회원 및 비회원을 말합니다.
3. "크리에이터"란 서비스를 통해 콘텐츠를 제작·배포하고 팬과 소통하는 이용자를 말합니다.
4. "구독자(팬)"란 크리에이터의 채널을 구독하고 메시지를 수신하는 이용자를 말합니다.
5. "DT(DreamTime)"란 서비스 내에서 사용되는 선불 충전 크레딧으로, 현금 또는 법정화폐가 아닙니다.
6. "펀딩"이란 크리에이터가 특정 목표를 설정하고 팬의 후원을 모집하는 기능을 말합니다.'''),
                  _buildArticle(isDark, '제3조 (약관의 효력 및 변경)', '''① 본 약관은 서비스 화면에 게시하거나 기타의 방법으로 이용자에게 공지함으로써 효력이 발생합니다.
...
③ 이용자가 변경된 약관에 동의하지 않는 경우 서비스 이용을 중단하고 탈퇴할 수 있습니다.'''),
                  _buildArticle(isDark, '제4조 (계정 관리)', '''① 이용자는 회원가입 시 정확한 정보를 제공해야 하며, 변경 사항이 있을 경우 즉시 수정해야 합니다.
...
④ 회사는 이용자가 서비스 이용을 원하지 않을 경우 계정 삭제를 요청할 수 있는 기능을 제공합니다.'''),
                  _buildArticle(isDark, '제5조 (DT 이용 및 결제)', '''① DT는 서비스 내에서만 사용 가능한 선불 충전 크레딧이며, 현금 또는 법정화폐가 아닙니다.
...
⑤ DT를 이용한 후원, 선물 등은 취소가 제한될 수 있으며, 구체적인 조건은 개별 서비스 안내를 따릅니다.'''),
                  _buildArticle(isDark, '제6조 (콘텐츠 정책)', '''① 이용자는 서비스 내에서 다음 각 호에 해당하는 콘텐츠를 게시할 수 없습니다.
...
② 회사는 위 사항에 해당하는 콘텐츠를 사전 통지 없이 삭제하거나 이용을 제한할 수 있습니다.'''),
                  _buildArticle(isDark, '제7조 (서비스 중단 및 책임 제한)', '''① 회사는 다음 각 호의 경우 서비스 제공을 일시적으로 중단할 수 있습니다.
...
③ 회사는 이용자의 귀책사유로 인한 서비스 이용 장애에 대해 책임을 지지 않습니다.'''),
                  _buildArticle(isDark, '제8조 (준거법 및 관할)', '''① 본 약관의 해석 및 적용에 관하여는 대한민국 법률을 적용합니다.
