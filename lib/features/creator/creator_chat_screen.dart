...
/// Creator Chat Screen - 크리에이터가 팬들과 소통하는 채팅 화면
/// 크리에이터가 메시지를 입력하면 자동으로 모든 팬에게 브로드캐스트됨
class CreatorChatScreen extends ConsumerStatefulWidget {
  const CreatorChatScreen({super.key});

  @override
  ConsumerState<CreatorChatScreen> createState() => _CreatorChatScreenState();
}

class _CreatorChatScreenState extends ConsumerState<CreatorChatScreen> {
