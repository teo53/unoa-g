...
class MockCelebrations {
  ...
  static List<FanCelebration> get sampleFanCelebrations => [
    FanCelebration(
      ...
      visibilityConsentAt: DateTime.now().subtract(const Duration(days: 30)),
      subscriptionStartedAt: DateTime.now().subtract(const Duration(days: 100)),
    ...
    FanCelebration(
      ...
      birthDay: DateTime.now().day,
      birthdayVisible: true,
      visibilityConsentAt: DateTime.now().subtract(const Duration(days: 60)),
      subscriptionStartedAt: DateTime.now().subtract(const Duration(days: 50)),
  ...
  static List<CelebrationTemplate> get defaultTemplates => [
    ...
    CelebrationTemplate(
      id: 'tpl_7',
      eventType: 'milestone_100',
      templateText: '100일이라니! {nickname}님 정말 감사해요 💖 {artist_name}이/가 항상 곁에 있을게요!',
      isDefault: true,
      sortOrder: 2,
      createdAt: DateTime.now(),
    ),
    ...
    CelebrationTemplate(
      id: 'tpl_9',
      eventType: 'milestone_365',
      templateText: '365일! {nickname}님과 함께한 1년은 정말 특별했어요 🌟 {artist_name} 드림 💕',
      isDefault: true,
      sortOrder: 2,
      createdAt: DateTime.now(),
    ),
