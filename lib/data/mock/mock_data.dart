...
class MockData {
  ...
  static final dtPackages = [
    DtPackage(
      ...
      priceKrw:
          BusinessConfig.chargeAmounts[0] * BusinessConfig.dtBaseUnitPriceKrw,
    ),
    DtPackage(
      id: 'pkg_2',
      name: '베이직',
      ...
      priceKrw:
          BusinessConfig.chargeAmounts[2] * BusinessConfig.dtBaseUnitPriceKrw,
      bonusDt: 50,
    ),
    DtPackage(
      id: 'pkg_3',
      ...
      priceKrw:
          BusinessConfig.chargeAmounts[3] * BusinessConfig.dtBaseUnitPriceKrw,
      bonusDt: 150,
      isPopular: true,
    ),
    DtPackage(
      ...
      priceKrw:
          BusinessConfig.chargeAmounts[4] * BusinessConfig.dtBaseUnitPriceKrw,
      bonusDt: 600,
    ),
  ];
